...
export function FeaturedVideoSection() {
  return (
    <section className="bg-black pt-6 md:pt-10 pb-20 md:pb-32 px-6 overflow-hidden w-full flex justify-center">
      <motion.div
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10 flex flex-col md:flex-row items-end justify-between gap-6">
          <div className="liquid-glass rounded-2xl p-6 md:p-8 max-w-md w-full md:w-auto">
            ...
            <p className="text-white text-sm md:text-base leading-relaxed text-left">
              We believe in the power of simplicity. Every financial journey starts with a question, and essara.space opens the door to clarity and peace of mind.
            </p>
          </div>
